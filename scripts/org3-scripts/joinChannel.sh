...
# test network home var targets to hashing-benchmark-project folder
# the reason we use a var here is considering with org3 specific folder
# when invoking this for org3 as hashing-benchmark-project/scripts/org3-scripts
# the value is changed from default as $PWD (hashing-benchmark-project)
